...
<div class="banner">
   <div class="start-nav">
      <h1>Puma</h1>
      <p>Discover the best puma shoes for you. Make people turn their heads wherever you go!</p>
   </div>
</div>
...
<section class="products" >
   <div class="head-container">
      <h1 class="heading">puma shoes</h1>
      <h3>
   ...
   <div class="box-container">
      ...
      $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE category = 'Puma'");
